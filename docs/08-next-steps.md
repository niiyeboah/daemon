...
| Model | Use Case |
|-------|----------|
| `llama3.2:3b` | General assistant (Daemon default) |
| `llama3.2:1b` | Faster responses for simple queries |
...
3. Inference speed will jump dramatically -- 50--100+ tokens/second on a mid-range GPU with the 3B model.
