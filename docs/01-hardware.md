...
2. Power on and complete macOS setup. Setup your API keys as in [OpenRouter API Accounts](03-openrouter-setup.md).
...
Next: [OS Setup](02-os-setup.md) (then [OpenRouter API Accounts](03-openrouter-setup.md) for macOS) or [OS Setup — Windows / Ubuntu](02-os-setup.md) (Beelink)
