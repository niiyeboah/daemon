...
const (
	DefaultBaseModel = "qwen2.5-coder:7b"
...
// If baseModel or customModel is empty, defaults are used (qwen2.5-coder:7b and "daemon").
...
func Check(out io.Writer, skipAPI bool, baseModel, customModel string) error {
	...
	if err != nil {
		...
		fmt.Fprintf(out, "Configure OpenRouter or see docs/03-openrouter-setup.md\n")
		return err
	}
	...
	for _, m := range tags.Models {
		// Model names can be "qwen2.5-coder:7b" or "daemon"
		names[m.Name] = true
		// Also match without tag for "qwen2.5-coder"
