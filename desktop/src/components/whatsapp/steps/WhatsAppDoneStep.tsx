...
import { MessageSquare, Activity, ExternalLink, PartyPopper } from "lucide-react";

export function WhatsAppDoneStep() {
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Daemon will now respond to your WhatsApp messages.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-lg border p-4">
        ...
        <p className="text-xs text-muted-foreground">
          For manual configuration and additional channels (Telegram, Discord, Slack), see the{" "}
          <a
            href="https://openclaw.ai/docs/channels"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1 text-primary hover:underline"
          >
            OpenClaw channels docs <ExternalLink className="size-3" />
          </a>
        </p>
      </div>
    </div>
